...
<span class="meta-badge">:material-github: <a href="https://github.com/ppngiap/claude-skills/tree/ppngiap/agents/finance/cs-financial-analyst.md">Source</a></span>
</div>
...
- [cs-ceo-advisor](https://github.com/ppngiap/claude-skills/tree/ppngiap/agents/c-level/cs-ceo-advisor.md) -- Strategic financial decisions, board reporting, and fundraising planning
- [cs-growth-strategist](https://github.com/ppngiap/claude-skills/tree/ppngiap/agents/business-growth/cs-growth-strategist.md) -- Revenue operations data and pipeline forecasting inputs
