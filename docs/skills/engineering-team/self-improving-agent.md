...
<span class="meta-badge">:material-github: <a href="https://github.com/ppngiap/claude-skills/tree/ppngiap/engineering-team/self-improving-agent/SKILL.md">Source</a></span>
</div>
...
- [playwright-pro](https://github.com/ppngiap/claude-skills/tree/ppngiap/engineering-team/playwright-pro) — sister plugin in this repo
