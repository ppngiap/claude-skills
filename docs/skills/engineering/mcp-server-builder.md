...
<span class="meta-badge">:material-github: <a href="https://github.com/ppngiap/claude-skills/tree/ppngiap/engineering/mcp-server-builder/SKILL.md">Source</a></span>
</div>
...
- [references/openapi-extraction-guide.md](https://github.com/ppngiap/claude-skills/tree/ppngiap/engineering/mcp-server-builder/references/openapi-extraction-guide.md)
- [references/python-server-template.md](https://github.com/ppngiap/claude-skills/tree/ppngiap/engineering/mcp-server-builder/references/python-server-template.md)
- [references/typescript-server-template.md](https://github.com/ppngiap/claude-skills/tree/ppngiap/engineering/mcp-server-builder/references/typescript-server-template.md)
- [references/validation-checklist.md](https://github.com/ppngiap/claude-skills/tree/ppngiap/engineering/mcp-server-builder/references/validation-checklist.md)
- [README.md](https://github.com/ppngiap/claude-skills/tree/ppngiap/engineering/mcp-server-builder/README.md)
