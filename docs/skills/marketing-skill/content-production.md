...
<span class="meta-badge">:material-github: <a href="https://github.com/ppngiap/claude-skills/tree/ppngiap/marketing-skill/content-production/SKILL.md">Source</a></span>
</div>
...
Fill in the [Content Brief Template](https://github.com/ppngiap/claude-skills/tree/ppngiap/marketing-skill/content-production/templates/content-brief-template.md). The brief defines:
...
See [references/content-brief-guide.md](https://github.com/ppngiap/claude-skills/tree/ppngiap/marketing-skill/content-production/references/content-brief-guide.md) for how to write a brief that actually produces better drafts.
...
See [references/optimization-checklist.md](https://github.com/ppngiap/claude-skills/tree/ppngiap/marketing-skill/content-production/references/optimization-checklist.md) for the full pre-publish checklist.
