...
<span class="meta-badge">:material-github: <a href="https://github.com/ppngiap/claude-skills/tree/ppngiap/marketing-skill/pricing-strategy/SKILL.md">Source</a></span>
</div>
...
See [references/pricing-models.md](https://github.com/ppngiap/claude-skills/tree/ppngiap/marketing-skill/pricing-strategy/references/pricing-models.md) for model deep dives and SaaS examples.
...
See [references/pricing-page-playbook.md](https://github.com/ppngiap/claude-skills/tree/ppngiap/marketing-skill/pricing-strategy/references/pricing-page-playbook.md) for design specs and copy templates.
